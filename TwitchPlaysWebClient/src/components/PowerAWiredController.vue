...
<script>
  import BaseController, { StandardMappings } from '../mixins/BaseController';
  ...
  export const PowerAWiredControllerChromeOS = {
    ...
    methods: {
      isButtonPressed(name) {
        if (Object.prototype.hasOwnProperty.call(this.dpadMapping, name)) {
          const mapping = this.dpadMapping[name];
          return mapping &&
            Object.prototype.hasOwnProperty.call(mapping, 'axis') &&
            Object.prototype.hasOwnProperty.call(mapping, 'sign') &&
            this.axes[mapping.axis] * mapping.sign > this.deadzone;
        }
  ...
  export const PowerAWiredControllerChrome = {
    ...
    methods: {
      isButtonPressed(name) {
        if (Object.prototype.hasOwnProperty.call(this.dpadMapping, name)) {
          const mapping = this.dpadMapping[name];
          if (!(mapping && Object.prototype.hasOwnProperty.call(mapping, 'axis') && Object.prototype.hasOwnProperty.call(mapping, 'axisVals'))) return false;
          const axisValNormalized = this.axes[mapping.axis] * 7;
